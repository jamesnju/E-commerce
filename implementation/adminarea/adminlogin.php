            ...
            <div class="col-lg-6 col-xl-5">
                ...
                <form action="" method="post">
                    ...
                    <div>
                        ...
                        <!-- <input type="submit" class="bg-info py-2 px-3 border text-light" value="Home"> -->
                        <a href="../users/login.php" class="bg-info py-2 px-3 border text-light text-decoration-none">Home</a>
