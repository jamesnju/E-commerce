<?php 
    ...
    if(isset($_POST['sellitem'])){
      ...
      $product_description = $_POST['nationalid'];
      $product_keywords = $_POST['Amount'];
      $category_id = $_POST['itemname'];
      $brand_id = $_POST['itemage'];
      $product_price= $_POST['description'];
      

      /*inserting images*/
      $product_image1 = $_FILES['productimage']['name'];
      $product_image2 = $_FILES['proof']['name'];
      ...
      $product_image1=='' or $product_image2=='' /* or $product_image3==''  */or $product_price==''){
          ...
          //insert query
          $Sql = "INSERT INTO `seller_detail` (seller_fname, national_id, price, item_name, reason, item_image, proof,description) VALUES ('$fname', '$id', '$sellprice', '$item', '$whysell', '$product_image1', '$proof_image2', '$description')";
    ...
    <h1 class="text-center text-success">Fill the form to Sell</h1>
        ...
        <form action="/" class="form" method="post" enctype="multipart/form-data">
            ...
            <label for=""><p>National Id</p>
                <input type="number" name="nationalid" placeholder="national id" min='0'  maxlength="8"  >
            </label>
            <label for=""><p>Selling Price</p>
                <input type="number" name="Amount" placeholder="Enter price of the item" >
            </label>
            ...
            <div class="age">
              ...
              <label>
              <input type="radio" name="itemage"  value="on" ><p>Upgrade</p>
              <input type="radio" name="itemage"  value="on" ><p>Old</p>
              <input type="radio" name="itemage"  value="on"  checked><p> Relocation</p>
              <input type="radio" name="itemage"  value="on" ><p>Unused</p>
              <input type="radio" name="itemage"  value="on" ><p>Earn Income</p>
              </label>
            </div>
            <label for=""><p>Product Image</p>
            ...
            <label for=""><p>Product Description</p>
                <input type="text" placeholder="Enter short description ofyour item"  name="description" >
            </label>
            <button name="sellitem">Submit</button>   
        </form>
        </fieldset>
