<?php
    if(isset($_GET['edit_account'])){//using the varible name edit_account
        ...
        if(isset($_POST['updateaccount'])){
            ...
            //update query
            $update_query="update `regislation` set username='$username',user_email='$user_email',user_password='$user_password',user_image='$user_image',user_address='$user_address',
...
<body>
    <fieldset class="border-5">
        ...
        <form class="text-center" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-outline mb-4">
                <input type="password" value="<?php echo $user_password ?>" name="user_password" class="form-control w-50 m-auto">
            </div>
